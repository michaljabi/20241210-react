export function UsingJsx() {
  ...
  const handleClick = () =>
    console.log("Można je zapisać w postaci funkcji - callback'a");
  ...
  return (
    <>
      ...
      <div className="box">
        ...
        <div>
          Dowolny <code>innerHTML</code> obliczany z kodu można zapisać tak:{" "}
          {600 + 20 * 2}
        </div>
        <div>
        ...
        <div
          ...
          onMouseOver={() => alert("Tak działają eventy")}
        >
          Tutaj najedź kursorem
        </div>
        <div className="notification mt-3" onClick={handleClick}>
          Tutaj kliknij i sprawdź <code>Console</code> w{" "}
          <em>narzędziach Dev</em> przeglądarki
        </div>
        <div
          style={{
        ...
        >
          <code>style</code> musi być obiektem i piszemy <code>className</code>{" "}
          zamiast <code>class</code>
        </div>
      </div>
    </>
  );
