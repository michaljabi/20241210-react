    ...
    <>
      ...
      <div>
        ...
        <ul>
          ...
          <li>Logikę w ciele funkcji (komponentu)</li>
        </ul>
        <blockquote>
          Komponenty będą posiadać oddzielne pliki <code>.jsx</code> lub{" "}
          <code>.tsx</code> podkreślające zawartość
          <code>JSX</code>. Dodatkowo ZAWSZE ich nazwy funkcji muszą zaczynać
          się Wielką Literą.
        </blockquote>
      </div>
    </>
